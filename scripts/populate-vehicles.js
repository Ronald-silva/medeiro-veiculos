...
const vehicles = [
  {
    ...
    description: 'Toyota Hilux 2009/2009, Cabine Dupla, Cambio Manual, 4x4, Cor Vermelha, Multimídia, Câmera de ré',
    status: 'available',
    stock_count: 1,
    images: Array(9).fill('/placeholder-car.jpg') // Placeholder até termos imagens reais
  },
  {
    name: 'Renault Kwid Intens 2018',
    brand: 'Renault',
    model: 'Kwid',
    price: 38500.00,
    year: 2018,
    ...
    features: ['Completo', '4 pneus zero', 'Vidros elétricos', 'Multimídia', 'Ar condicionado'],
    description: 'Renault Kwid 2017/2018 Versão Intens, Motor 1.0, Câmbio Manual, Completo, 4 pneus zero, Bancada em perfeito estado',
    status: 'available',
    stock_count: 1,
